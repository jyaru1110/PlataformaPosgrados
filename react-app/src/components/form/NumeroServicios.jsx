export default function NumeroServicios(props) {
    ...
    return (
        <div className="flex flex-col w-auto">
            ...
            <input type="number" className="font-poppins text-sm w-[142px] h-7 bg-primarylight text-gray1 rounded-md px-2.5 mb-4" onChange={handleChange} defaultValue={value}></input>
        </div>
    )
}
