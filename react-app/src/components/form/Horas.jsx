    ...
    return (
        <div className="flex w-full justify-between">
            <div className="flex flex-col">
                ...
                <input className="w-36 font-poppins text-sm h-7 bg-primarylight text-gray1 rounded-md px-2.5 mb-4" type="time" onChange={handleInicio} defaultValue={inicio}/>
            </div>
            <div className="flex flex-col">
                <label className="font-poppins text-sm ml-1 mb-2 font-thin">Hora de fin</label>
                <input className="w-36 font-poppins text-sm h-7 bg-primarylight text-gray1 rounded-md px-2.5 mb-4" type="time" onChange={handleFin} defaultValue={fin}/>
            </div>
        </div>
    );
  }