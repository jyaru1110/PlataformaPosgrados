...
import Accordion from "../Programas/Components/Accordion";
import AccordionLoader from "../Programas/Components/AccordionLoader";
import GradeCounter from "../Programas/Components/GradeCounter";
      ...
      <Main>
        <div className="flex mx-auto justify-center space-x-3 mb-8">
          <div className="bg-white p-5 rounded-md flex items-center space-x-4">
            <p className="text-4xl">☕️️</p>
            <p>Coffee breaks</p>
          </div>
          <div className="bg-white p-5 rounded-md">
            <p>Seguimiento posgrados</p>
          </div>
        </div>
