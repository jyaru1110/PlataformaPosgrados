export default function Form({ children, title, onSubmit, register }) {
  return (
    <form onSubmit={onSubmit} className="p-5 w-full bg-white rounded-lg border border-grayborder space-y-3">
      <input {...register} className="w-full font-bold text-2xl mb-4 hover:border-gray-200 border-white/0 border-b focus:border-emerald-700" required placeholder={title}></input>
