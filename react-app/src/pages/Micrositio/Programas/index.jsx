                ...
                {escuela?.programas?.map((programa) => {
                  return (
                    ...
                    >
                        ...
                        <div className="space-x-4 mt-[46px!important]">
                          <Link className="text-white bg-primary px-3.5 py-2 rounded-full cursor-pointer" href={programa.website}>Website</Link>
                          <Link className="text-white bg-primary px-3.5 py-2 rounded-full cursor-pointer" href={programa.encarte}>Encarte</Link>
                        </div>
                    </Accordion>
                  );
                })}
