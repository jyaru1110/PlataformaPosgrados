...
export default function SumaDia(props) {
  ...
  const csvData = [
    ["FECHA", "ÁREA", "HORARIO DE EVENTO", "TIPO DE SOLICITUD", "NO. DE PERSONAS", "LUGAR DE ENTREGA","OBSERVACIONES","INICIALES","FOLIO","CUENTA","FOLIO FACTURA","MONTO"],
  ];
            ...
            <div>
              {sumas.sumas.map((suma) => (
                ...
                >
                  ...
                  <p className="font-poppins text-xs text-center font-thin text-graytextsecondary">
                    servicios
                  </p>
                </div>
              ))}
