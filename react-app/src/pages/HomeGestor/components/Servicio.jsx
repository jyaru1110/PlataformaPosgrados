export default function Servicio(props){
    ...
    return(
        <div className={`group/item w-full bg-primarylight text-primary p-2 my-2 rounded-xl flex justify-between items-center h-14 ${servicio.estado !== 'Confirmado'? " opacity-50":" opacity-100"}`}>
            <div className="flex flex-row">
                <p className="font-poppins font-thin text-sm text-gray1">{servicio.hora_servicio_inicio.substring(0,5)} - {servicio.hora_servicio_fin.substring(0,5)}</p>
