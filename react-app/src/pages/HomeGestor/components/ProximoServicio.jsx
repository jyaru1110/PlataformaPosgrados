        ...
        <div className = "bg-primary m-auto text-white rounded-2xl p-4 flex flex-row items-center justify-between">
            ...
            (
                <div className="flex flex-col items-stretch h-full">
                    <h1 className = "font-poppins text-sm font-semibold">{servicio.salon}</h1>
                    <h1 className = "font-poppins text-sm font-semibold">{servicio.hora_inicio.substring(0,5)} - {servicio.hora_fin.substring(0,5)}</h1>
                    <h1 className = "font-poppins text-sm font-semibold">{servicio.programa}</h1>
                    <h1 className = "font-poppins text-sm font-semibold">{servicio.fecha}</h1>
                    <h1 className = "font-poppins text-sm font-semibold">{servicio.num_servicios} servicios</h1>
                </div>
            )
            }
