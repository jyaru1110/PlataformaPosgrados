export default function ButtonAdd() {
    return (
        <button className="bottom-24 md:bottom-0 md:relative shadow-[0px_1px_4px_rgba(0,0,0,0.25)] absolute bg-primary h-12 w-12 rounded-full justify-center flex content-center flex-wrap transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-300 md:mt-2">
