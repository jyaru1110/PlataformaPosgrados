...
const send_servicios_confirmados = async (
  ...
  const html =
    ...
    servicios
      ...
      .join("") +
    "</tbody>" +
    '</table><a href="https://posgradospanamericana.up.edu.mx/confirmados">Aprueba los servicios confirmados aquí</a></div>';
  try {
    const transporter = nodemailer.createTransport(config);
    const mailOptions = {
      from: '"Coffee breaks" <mx_eventos@up.edu.mx>',
