...
const send_servicios_confirmados = async (email, semana, servicios) => {
  const html =
    "<div><h7>Coffees confirmados para la semana " +
      semana +
      ". <b>En caso de no corroborar o corregir los servicios confirmados con el proveedor, se dará por hecho que son correctos y se cobrará de manera correspondiente.</b></h7>" +
     ( servicios?.length >
    0
