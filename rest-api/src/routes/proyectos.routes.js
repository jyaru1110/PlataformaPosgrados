...
const {delete_seccion, delete_link, get_proyectos, create_proyecto, get_proyecto, update_proyecto, delete_proyecto, upload_photo, get_proyectos_promocion, get_secciones_promocion} = require("../controllers/proyectos.controller");
