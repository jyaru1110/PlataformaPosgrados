...
const router = Router();
const {get_programas_escuela,get_programas_opciones,update_programa} = require('../controllers/programas.controllers');
const { isUserAuthenticated } = require('../middlewares/auth');

router.get('/programas/:escuela',get_programas_escuela);
router.get('/programas_opciones',get_programas_opciones);
//router.get('/programas/:programa',get_programas_todos);
